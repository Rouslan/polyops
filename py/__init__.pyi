...
class Clipper:
    ...
    def add_offset(self,loop: PointArrayLike,bset: BoolSet,magnitude: float,arc_step_size: int,closed: bool = ...,*,casting: CastingKind = ...) -> None: ...

    def add_offset_subject(self,loop: PointArrayLike,magnitude: float,arc_step_size: int,closed: bool = ...,*,casting: CastingKind = ...) -> None: ...

    def add_offset_clip(self,loop: PointArrayLike,magnitude: float,arc_step_size: int,closed: bool = ...,*,casting: CastingKind = ...) -> None: ...

    def add_offsets(self,loops: Iterable[PointArrayLike],bset: BoolSet,magnitude: float,arc_step_size: int,closed: bool = ...,*,casting: CastingKind = ...) -> None: ...

    def add_offsets_subject(self,loops: Iterable[PointArrayLike],magnitude: float,arc_step_size: int,closed: bool = ...,*,casting: CastingKind = ...) -> None: ...

    def add_offsets_clip(self,loops: Iterable[PointArrayLike],magnitude: float,arc_step_size: int,closed: bool = ...,*,casting: CastingKind = ...) -> None: ...
...
class TrackedClipper:
    ...
    @property
    def next_orig_i(self) -> int: ...

    @next_orig_i.setter
    def next_orig_i(self,val: int) -> None: ...
